...
public class AndroidShare {
     ...
     *            (分享图片，若分享类型为AndroidShare.TEXT，则可以为null)
     */
    public void shareEmail(String msgTitle, String msgText,Bitmap drawable) {
        // 调用系统发邮件
    ...
    public static Boolean sendSms(Context mContext, String smstext) {
        ...
        intent.putExtra("body", "内容");
        Uri uri=Uri.parse("file://mnt/sdcard/icon.png");
     ...
     */
    @SuppressLint("NewApi")
    public void shareMsg(String packageName, String activityName,
...
//          Bitmap bt = bd.getBitmap();
    ...
    public void sharedQQ(Activity context, Bitmap bitmap){
        Uri uri = Uri.parse(MediaStore.Images.Media.insertImage(
                context.getContentResolver(), BitmapFactory.decodeResource(context.getResources(), R.drawable.ac3), null, null));
